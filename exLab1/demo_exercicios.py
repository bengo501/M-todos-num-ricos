"""
Métodos Numéricos - Demonstração dos Exercícios 1-11
...
def main():
    """
    Executa os exercícios 1-11
    """
    print("MÉTODOS NUMÉRICOS - SOLUÇÃO DE EQUAÇÕES")
    print("Demonstração dos Exercícios 1-11")
    print("=" * 50)
    ...
    print("Para executar o exercício 12 (fractais), use o arquivo solucao_exercicios.py")
