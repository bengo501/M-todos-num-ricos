...
resultadoLagrange, resultadoNewton = metodoLagrange(pesos, tempos, pesoDoPeru), metodoNewton(pesos, tempos, pesoDoPeru) # resultado do metodo de lagrange e newton
horas, minutos = int(resultadoLagrange // 60), int(resultadoLagrange % 60) #resultadoLagrange dividido por 60 para obter as horas e o resto para os minutos
print(" ================================================ ")
...
print(" \nverificacao: \n")
for p, t in zip(pesos, tempos):                # p (peso) t (tempo)
    calc = metodoLagrange(pesos, tempos, p)                   #  calc (resultado do metodo de lagrange)
